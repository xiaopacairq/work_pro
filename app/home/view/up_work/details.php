...
<body>
    ...
    function del(id) {
        layer.confirm('确定要删除？', {
            ...
            $.post('/student/class_upwork_details_delfile', {
                id
            }, function(res) {
                if (res.status != 200) {
    ...
    function to_do(is_true, work_id, stu_no) {
        ...
        layer.confirm("确定要" + (is_true == 1 ? "提交" : "取消") + "吗？", {
            ...
            $.post('/student/class_upwork_details_is_true', {
                is_true,
                work_id,
                stu_no
            }, function(res) {
    ...
    var uploadListIns = upload.render({
        ...
        elemList: $('#demoList') //列表元素对象
            ,
        url: '/student/class_upwork_details_upfile' //此处用的是第三方的 http 请求演示，实际使用时改成您自己的上传接口即可。
            ,
        accept: 'file',
        multiple: true,
        auto: false,
