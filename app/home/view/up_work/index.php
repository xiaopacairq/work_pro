            ...
            <div class="layui-panel">
                ...
                <div class="panel-foot">
                    <em style="color:<?= ($recent_date > $work['work_last_time']) ? "#ccc" : "" ?>">截止时间：{$work.work_last_time|date='Y-m-d
                        H:i'}</em>
                    <button type="button" class="layui-btn layui-btn-sm  layui-btn-warm <?= ($recent_date > $work['work_last_time']) ? "layui-btn-disabled" : "" ?>" onclick='upfile("{$work.work_id}")'>
...
<script>
    ...
    function upfile(work_id) {
        layer.open({
            ...
            anim: 5,
            maxmin: true,
            content: '/student/class_upwork_details?work_id=' + work_id,
            offset: 't',
            shade: 0.3,
            shadeClose: true,
