...
<body>
        ...
        <div class="layui-from">
            <div class="form-item">
                ...
                <div class="input-item">
                    <input type="text" name="class_id" required lay-verify="required" placeholder="请输入班级代码"
                        autocomplete="off" class="layui-input" value="2005">
                </div>
            </div>
            <div class="form-item">
                ...
                <div class="input-item">
                    <input type="text" name="stu_no" required lay-verify="required" placeholder="请输入学号"
                        autocomplete="off" class="layui-input" value="201120184">
                </div>
            </div>
            <div class="form-item">
            ...
            <div class="form-item">
                ...
                <div class="input-item captcha">
                    ...
                    <img id="captcha" src="/student/verify" alt="" onclick="reloadveriimg(this)">
                </div>
            </div>
            <div class="form-item">
    ...
    function reloadveriimg(obj) {
        ...
        $(obj).attr('src', '/student/verify?rand=' + Math.random());
    }
        ...
        if (class_id == '' || stu_no == '' || stu_pwd == '' || captcha == '') {
            ...
            $.post('/student/check', {
                ...
                if (res.status != 200) {
                    ...
                    setTimeout(function() {
                        window.location.href = '/student/class_home'
                    }, 1000);
                }
            }, 'json');
        }
