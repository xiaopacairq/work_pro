...
function get_zip(class_id) {
    layer.confirm('确定要下载吗？', {
        ...
        window.location.href = '/teacher/class_stu_get_zip?class_id=' + class_id;
...
function add(class_id) {
    layer.open({
        ...
        shadeClose: false,
        anim: 5,
        content: '/teacher/class_stu_add?class_id=' + class_id,
        offset: 't',
        shade: 0.3,
        shadeClose: true
    });
...
function up_stu(class_id) {
    layer.open({
        ...
        area: ['520px', '240px'], //宽高
        shade: 0.8,
        content: '/teacher/class_stu_upfile?class_id=' + class_id
    });
}
...
function send_all_email(class_id, class_name, is_all) {
    layer.confirm('确定要群发吗？', {
        ...
        $.post('/teacher/class_stu_send_email', {
            class_id,
            class_name,
            is_all
        }, function(res) {
...
function edit(class_id, stu_no) {
    layer.open({
        ...
        shadeClose: false,
        anim: 5,
        content: '/teacher/class_stu_edit?class_id=' + class_id + '&stu_no=' + stu_no,
        offset: 't',
        shade: 0.3,
        shadeClose: true
    });
...
function search(class_id) {
    ...
    window.location.href = '/teacher/class_stu?class_id=' + class_id + '&search=' + search;
}
// 清空
