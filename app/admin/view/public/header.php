...
<button class="layui-btn layui-btn-primary layui-border-black exit2"
    onclick="window.location.href='/teacher/welcome'">返回</button>
...
<div class="header">
    ...
    <ul class="layui-nav" lay-filter="">
        <li class="layui-nav-item {$class.title=='班级配置'? 'layui-this' : ''}"><a
                href="/teacher/class_home?class_id={$class.class_id}">班级配置</a></li>
        <li class="layui-nav-item  {$class.title=='学生管理'? 'layui-this' : ''}"><a
                href="/teacher/class_stu?class_id={$class.class_id}">学生管理</a></li>
        <li class="layui-nav-item {$class.title=='作业布置'? 'layui-this' : ''}""><a href="
            /teacher/class_work?class_id={$class.class_id}">作业布置</a></li>
        <li class=" layui-nav-item {$class.title=='成绩管理' ? 'layui-this' : '' }""><a href="
            /teacher/class_score?class_id={$class.class_id}">成绩管理</a></li>
    </ul>
</div>
<script>
