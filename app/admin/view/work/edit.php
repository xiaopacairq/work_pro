...
<body style="padding: 10px;">
    ...
    <div class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            <button class="layui-btn layui-btn-normal" onclick="save('{$work.class_id}','{$work.work_id}')">保存</button>
    ...
    function save(class_id, work_id) {
    ...
    function detail(class_id, stu_no, work_id) {
        layer.open({
            ...
            anim: 5,
            offset: 't',
            content: '/teacher/class_work_detail?stu_no=' + stu_no + '&work_id=' + work_id + '&class_id=' +
                class_id,
        });
    }
    </script>
